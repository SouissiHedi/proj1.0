...
session_start();
$gg=$_POST['sujet'];
$query0= "SELECT * FROM catégories where catégorie LIKE '%$gg%'";
      ...
      <div class="tab-content image" id="pills-tabContent">
        ...
        <div class="tab-pane fade active show" id="pills-products" role="tabpanel" aria-labelledby="pills-products-tab">
            ...
            <div class="container">
              ...
              <?php
                if($typeint['dispo']){
                  $query = "SELECT * FROM don WHERE id_catégories=$ty";
                  $query_count = "SELECT COUNT(*) FROM don WHERE id_catégories=$ty";
              ...
              <div class="row" style="padding-top: 2rem">
                ...
                <div class="col-lg-3 col-sm-1">
                  <div class="card element box">
                      <!-- Image -->
                    <div class="card-image"><img class="fiximg" src='data:image/png;base64,<?=base64_encode($arr[$i*4+$j]['photos'])?>' alt="Responsive image"></div>
                    <!-- Corp de notre carte -->
                    <div class="card-body">
                      <!-- Titre du jeu -->
                      ...
                      <div class="card-excerpt">
                        <p><?=$arr[$i*4+$j]['caractéristiques'];?></p>
                      </div>
                      <div class="card-excerpt">
              ...
              <?php
                  ...
                  <div class="container products_heading">
                    <h4>
                    Impossible d'accéder à ces produits dans cette période
                    </h4>
                  </div>
                <?php
                }
